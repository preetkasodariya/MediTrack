            ...
            <form method="Post">
                ...
                <div class="auth-box">
                    ...
                    if (isset($_POST["btnsubmit"])) {
                        ...
                        $result = mysqli_query($conn, "select * from tbl_doctors where doc_email = '$email' ") or die(mysqli_error($conn));
                        ...
                        if ($row >= 1) {
                            ...
                            // Sender info 
                            $mail->setFrom('preetkasodariya3008@gmail.com', 'MediTrack');
                            $mail->addReplyTo('preetkasodariya3008@gmail.com', 'MediTrack');
