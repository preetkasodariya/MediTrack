        ...
        <div class="auth-wrapper">
            ...
            <div class="auth-box">
                ...
                if (isset($_POST["btnsubmit"])) {
                    ...
                    $result = mysqli_query($conn, "select * from tbl_doctors where username='$txtUname' and password='$txtpws'") or die(mysqli_error($conn));
                ...
                <?php
                        ...
                        while($row = mysqli_fetch_assoc($result))
                        {
                            ...
                            $_SESSION["DocUname"] = $row["username"];
                            $_SESSION["DocPassword"] = $row["password"];
                            $_SESSION["DocEmail"] = $row["doc_email"];
                            $_SESSION["DocNum"] = $row["doc_number"];
                            $_SESSION["DocAbout"] = $row["about_doctors"];
                            $_SESSION["DocName"] = $row["first_name"]. " " . $row["last_name"];
                            $_SESSION["Docimg"] = $row["doc_image"];
