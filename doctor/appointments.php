                ...
                <div class="card-body">
                  <form method="POST">
                    ...
                    <div class="mb-3" style="max-height: 300px; overflow-y: auto;">
                      <label class="form-label">Time</label>
                      <select class="form-select" name="medtime">
                        <option value=''>Please select medicine time</option>
                    ...
                    <div class="mb-3">
                      ...
                      <select class="form-select" name="medtype">
                        <option value=''>Please select Intake time</option>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                if (isset($_POST["trtsubmit"])) {
                  ...
                  $result = mysqli_query($conn, "insert into tbl_treatment (problem,solution,next_date,reports,medicine_take,appointment_id) values ('$prob','$soln','$nxtdate','$report','$medtake','$appid')") or die(mysqli_error($conn));


                  $result = mysqli_query($conn, "update tbl_appointment set status='complete' where appointment_id='$appid'") or die(mysqli_error($conn));
                  ...
                  <div class="row gx-3">
                    <div class="col-sm-12">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea type="text" class="form-control" id="prob" name="prob" placeholder="Enter Problem"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="mb-3">
                        <label class="form-label" for="a1">Solutions <span
                            class="text-danger">*</span></label>
                        <textarea type="text" class="form-control" id="soln" name="soln" placeholder="Enter Solutions"></textarea>
                      </div>
                    </div>

                    <div class="col-sm-12">
                      <div class="mb-3">
                        <label class="form-label" for="selectGender1">Report <span
                            class="text-danger">*</span></label>
                        <div class="m-0">
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="report" id="report"
                              value="yes">
                            <label class="form-check-label" for="selectGender1">Yes</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="report" id="report"
                              value="no" checked>
                            <label class="form-check-label" for="selectGender2">No</label>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="mb-3">
                        <label class="form-label" for="a1">Next Date <span
                            class="text-danger">*</span></label>
                        <input type="date" class="form-control" id="nxtdate" name="nxtdate" placeholder="Enter State Name">
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                      <div class="mb-3">
                        <label class="form-label" for="selectGender1">medicine take <span
                            class="text-danger">*</span></label>
                        <div class="m-0">
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="medtake" id="medtake"
                              value="yes">
                    ...
                    <div class="col-sm-12">
                      <div class="d-flex gap-2 justify-content-end">
                        <button type="submit" name="trtsubmit" class="btn btn-primary">
                          Submit
                        </button>
                      </div>
                    </div>
