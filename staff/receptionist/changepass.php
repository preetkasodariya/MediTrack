                            ...
                            <div class="card">
                                ...
                                <?php 
                                     ...
                                     if(isset($_POST["btnsubmit"]))
                                     {
                                        ...
                                        $result = mysqli_query($conn,"select * from tbl_staff where staff_id='$id' and password='$oldpass'");
                                        ...
                                        {
                                        $result = mysqli_query($conn,"update tbl_staff set password='$NewPass' where staff_id='$id'");
                                        if($result)
                                        {
