                    ...
                    <div class="table-responsive">
                      <table class="table truncate align-middle">
                        ...
                        <tbody>
                          ...
                          $count = 1;
                          $id = $_GET["dataid"];
                          $result = mysqli_query($conn, "select * from tbl_patients where patient_id='$id'") or die(mysqli_error($conn));
                          ...
                          ?>
                            ...
                            <tr>
                              <th  width="100px" style="border-radius: 50%;">IMAGE</th>
                              <td><img src="uploads/patient/<?php echo $row["patient_image"]; ?>" height="100" width="100" alt=""></td>
                            </tr>
