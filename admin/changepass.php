                            ...
                            <div class="card">
                                ...
                                <?php 
                                     ...
                                     if(isset($_POST["btnsubmit"]))
                                     {
                                        ...
                                        $result = mysqli_query($conn,"select * from tbl_admin where admin_id='$id' and password='$oldpass'");
                                        ...
                                        {
                                        $result = mysqli_query($conn,"update tbl_admin set password='$NewPass' where admin_id='$id'");
                                        if($result)
                                        {
