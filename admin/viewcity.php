        ...
        <div class="app-hero-header d-flex align-items-center">
          ...
          <div class="ms-auto d-lg-flex d-none flex-row">
            <div class="d-flex flex-row gap-1 day-sorting">
              <a href="addcity.php" class="btn btn-sm btn-primary">Add City</a>
            ...
            <div class="col-sm-12">
              <div class="card mb-3">
                ...
                if (isset($_POST["deletebtn"])) {
                  ...
                  $result = mysqli_query($conn, "delete from tbl_city where city_id='$did'") or die(mysqli_error($conn));
                }
                    ...
                    <div class="table-responsive">
                      <table class="table truncate align-middle">
                        ...
                        <tbody>
                          ...
                          $result = mysqli_query($conn, "select * from tbl_city as c left join tbl_states as s on c.state_id=s.state_id") or die(mysqli_error($conn));
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                <a href="editcity.php?updateid=<?php echo $row["city_id"]; ?>" class="btn btn-primary">Edit</a>
                                <button data-id="<?php echo $row["city_id"]; ?>" id="btndelete" data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-danger">Delete</button>
                              </td>
                            </tr>
                          <?php
